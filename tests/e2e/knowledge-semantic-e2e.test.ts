...
const scenarioAssertions: Record<(typeof requiredScenarios)[number], string[]> = {
  ...
  "skill-gate-partial": ["partial-catalog-missing", "partial-warning-subset"],
  "memory-load-unload": ["unloaded-body-absent", "loaded-body-rendered", "unload-removes-body", "loaded-set-persisted", "unload-persisted"],
  "memory-consolidation": ["nohash-rejected", "search-exposes-hash", "consolidated-single-section", "stalehash-rejected", "date-topic-advisory"],
  "skill-write-propagation": ["new-skill-absent-before", "new-skill-present-after-no-reload", "skill-file-on-disk"],
  "reload-persistence": ["window-set-via-command", "loaded-domain-survives-reload", "window-survives-reload", "domain-rendered-post-reload"],
  "cache-byte-stability": ["prompt-stable-across-nochange", "prompt-changes-once-after-load", "prompt-stable-after-change"],
  "command-surface": ["cmd-load-persisted", "cmd-unload-persisted", "cmd-window-persisted", "cmd-rejects-unsafe-domain"],
